    ...
    return (
        <div>
            <Grid container justify='center'>
                <Paper style={{ width: '80%', marginBottom:'2rem' }}>
                    <div style={{ margin: '1rem 3rem 1rem' }}>
                        <h1>Terms and Conditions</h1>
                        <p>Last updated: July 28, 2019</p>
                        <p>Please read these Terms and Conditions ("Terms", "Terms and
                        Conditions") carefully before using the Who's Crowded mobile application
                        (the "Service") operated by DRAKO APPS HOLDING COMPANY Inc. ("us", "we",
        or "our").</p>
        ...
        permission to access the Service.</p>
                        ...
                        <p>By creating an Account on our service, you agree to subscribe to
        ...
        correct and complete.</p>
                        <p>The service may employ the use of third party services for the purpose
        ...
        these third parties subject to our Privacy Policy.</p>
                        ...
                        Service. We may experience delays in updating information on the Service
                        and in our advertising on other web sites. The information found on the
                        Service may contain errors or inaccuracies and may not be complete or
                        current. Products or services may be mispriced, described inaccurately,
                        or unavailable on the Service and we cannot guarantee the accuracy or
        completeness of any information found on the Service.</p>
                        <p>We therefore reserve the right to change or update information and to
        ...
        select when purchasing a Subscription.</p>
                        <p>At the end of each Billing Cycle, your Subscription will automatically
                        renew under the exact same conditions unless you cancel it or DRAKO APPS
                        HOLDING COMPANY Inc. cancels it. You may cancel your Subscription
                        renewal either through your online account management page or by
        contacting DRAKO APPS HOLDING COMPANY Inc. customer support team.</p>
                        <p>A valid payment method, including credit card or PayPal, is required to
                        process the payment for your Subscription. You shall provide DRAKO APPS
                        HOLDING COMPANY Inc. with accurate and complete billing information
                        ...
                        information, you automatically authorize DRAKO APPS HOLDING COMPANY Inc.
                        to charge all Subscription fees incurred through your account to any
        such payment instruments.</p>
                        <p>Should automatic billing fail to occur for any reason, DRAKO APPS
                        HOLDING COMPANY Inc. will issue an electronic invoice indicating that
        ...
        payment corresponding to the billing period as indicated on the invoice.</p>
                        <h2>Fee Changes</h2>
                        <p>DRAKO APPS HOLDING COMPANY Inc., in its sole discretion and at any
                        time, may modify the Subscription fees for the Subscriptions. Any
                        Subscription fee change will become effective at the end of the
        then-current Billing Cycle.</p>
                        <p>DRAKO APPS HOLDING COMPANY Inc. will provide you with a reasonable
        ...
        effective.</p>
                        <p>Your continued use of the Service after the Subscription fee change
                        comes into effect constitutes your agreement to pay the modified
        Subscription fee amount.</p>
                        <h2>Refunds</h2>
        ...
        appropriateness.</p>
                        <p>By posting Content on or through the Service, You represent and warrant
        ...
        infringing on a copyright.</p>
                        <p>You retain any and all of your rights to any Content you submit, post
                        ...
                        Service. However, by posting Content using the Service you grant us the
                        right and license to use, modify, publicly perform, publicly display,
                        reproduce, and distribute such Content on and through the Service. You
        ...
        subject to these Terms.</p>
                        <p>DRAKO APPS HOLDING COMPANY Inc. has the right but not the obligation to
        monitor and edit all Content provided by users.</p>
                        <p>In addition, Content found on or through this Service are the property
                        of DRAKO APPS HOLDING COMPANY Inc. or used with permission. You may not
        ...
        personal gain, without express advance written permission from us.</p>
                        <h2>Accounts</h2>
                        <p>When you create an account with us, you guarantee that you are above
        ...
        name that is offensive, vulgar or obscene.</p>
                        <p>We reserve the right to refuse service, terminate accounts, remove or
        edit content, or cancel orders in our sole discretion.</p>
                        <h2>Intellectual Property</h2>
                        <p>The Service and its original content (excluding Content provided by
                        users), features and functionality are and will remain the exclusive
                        property of DRAKO APPS HOLDING COMPANY Inc. and its licensors. The
        ...
        written consent of DRAKO APPS HOLDING COMPANY Inc..</p>
                        <h2>Links To Other Web Sites</h2>
                        <p>Our Service may contain links to third party web sites or services that
        are not owned or controlled by DRAKO APPS HOLDING COMPANY Inc.</p>
                        <p>DRAKO APPS HOLDING COMPANY Inc. has no control over, and assumes no
                        responsibility for the content, privacy policies, or practices of any
                        third party web sites or services. We do not warrant the offerings of
        any of these entities/individuals or their websites.</p>
                        <p>You acknowledge and agree that DRAKO APPS HOLDING COMPANY Inc. shall
        ...
        policies of any third party web sites or services that you visit.</p>
                        <h2>Termination</h2>
                        <p>We may terminate or suspend your account and bar access to the Service
        ...
        liability.</p>
                        ...
                        <p>You agree to defend, indemnify and hold harmless DRAKO APPS HOLDING
                        COMPANY Inc. and its licensee and licensors, and their employees,
        ...
        or c) Content posted on the Service.</p>
                        <h2>Limitation Of Liability</h2>
                        <p>In no event shall DRAKO APPS HOLDING COMPANY Inc., nor its directors,
        ...
        set forth herein is found to have failed of its essential purpose.</p>
                        <h2>Disclaimer</h2>
                        <p>Your use of the Service is at your sole risk. The Service is provided
        ...
        particular purpose, non-infringement or course of performance.</p>
                        <p>DRAKO APPS HOLDING COMPANY Inc. its subsidiaries, affiliates, and its
        ...
        damages, so the limitations above may not apply to you.</p>
                        <h2>Governing Law</h2>
        ...
        agree to the new terms, you are no longer authorized to use the Service.</p>
                        <h2>Contact Us</h2>
